...
typedef struct SinglyLinkedNode
{
    ...
    struct SinglyLinkedNode *next;   // Pointer to next node
} SinglyLinkedNode;

// Singly linked list structure with custom allocator support
typedef struct SinglyLinkedList
{
    SinglyLinkedNode *head;          // Pointer to first node
 ...
 */
SinglyLinkedNode *sll_find(const SinglyLinkedList *list, const void *data, cmp_func compare);
 ...
 */
int sll_equals(const SinglyLinkedList *list1, const SinglyLinkedList *list2, cmp_func compare);
 ...
 */
int sll_insert_at(SinglyLinkedList *list, size_t pos, void *data);
 ...
 * @return 0 on success, -1 on error
 */
int sll_sort(SinglyLinkedList *list, cmp_func compare);
 ...
 * @return 0 on success, -1 on error
 */
int sll_splice(SinglyLinkedList *dest, SinglyLinkedList *src, size_t pos);
 ...
 */
SinglyLinkedList *sll_filter(const SinglyLinkedList *list, pred_func pred);
 ...
 */
void sll_for_each(const SinglyLinkedList *list, action_func action);
