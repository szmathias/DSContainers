...
DSCString dsc_str_create_empty(size_t initial_capacity);
...
void dsc_str_destroy_split(DSCString **str, size_t count);

// Clears the content of your string and assigns the value given
void dsc_str_assign_char(DSCString *str, char value);
...
void dsc_str_push_back(DSCString *str, char value);

// Appends a cstring or another String to the end of your string
void dsc_str_append_char(DSCString *str, char value);
...
void dsc_str_insert_char(DSCString *str, size_t pos, char value);

void dsc_str_insert_cstring(DSCString *str, size_t pos, const char *cstr);

void dsc_str_insert_string(DSCString *str, size_t pos, const DSCString *from);
...
void dsc_str_erase(DSCString *str, size_t pos);
...
bool dsc_str_reserve(DSCString *str, size_t new_capacity);
...
DSCString dsc_str_substr_create_cstring(const char *cstr, size_t pos, size_t count);

DSCString dsc_str_substr_create_string(const DSCString *str, size_t pos, size_t count);
...
char *dsc_str_substr_cstring(const char *cstr, size_t pos, size_t count, char *buffer);

char *dsc_str_substr_string(const DSCString *str, size_t pos, size_t count, char *buffer);
