 ...
 */
ANV_API ANVBinarySearchTree* anv_bst_create(ANVAllocator* alloc, cmp_func compare);
 ...
 */
ANV_API void anv_bst_inorder(const ANVBinarySearchTree* tree, action_func action);
 ...
 * @param action Function to call for each element
 */
ANV_API void anv_bst_preorder(const ANVBinarySearchTree* tree, action_func action);
 ...
 * @param action Function to call for each element
 */
ANV_API void anv_bst_postorder(const ANVBinarySearchTree* tree, action_func action);
 ...
 */
ANV_API ANVBinarySearchTree* anv_bst_from_iterator(ANVIterator* it, ANVAllocator* alloc, cmp_func compare, bool should_copy);
