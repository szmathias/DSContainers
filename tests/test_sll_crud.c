...
int test_insert_front_back_find(void)
{
    ...
    *c = 3;
    ASSERT_EQ(dsc_sll_push_front(list, a), 0);
    ASSERT_EQ(dsc_sll_push_back(list, b), 0);
    ASSERT_EQ(dsc_sll_push_back(list, c), 0);
...
{
    ASSERT_EQ(dsc_sll_push_back(NULL, NULL), -1);
    ASSERT_EQ(dsc_sll_push_front(NULL, NULL), -1);
...
int test_insert_at(void)
{
    ...
    *b = 2;
    int* c = malloc(sizeof(int));
    *c = 3;
    ASSERT_EQ(dsc_sll_push_back(list, a), 0);  // [1]
    ASSERT_EQ(dsc_sll_push_back(list, c), 0);  // [1,3]
...
int test_remove_at(void)
{
    ...
    *b = 20;
    int* c = malloc(sizeof(int));
    *c = 30;
    dsc_sll_push_back(list, a); // [10]
    dsc_sll_push_back(list, b); // [10,20]
    dsc_sll_push_back(list, c); // [10,20,30]
...
int test_remove_at_head(void)
{
    ...
    *a = 100;
    int* b = malloc(sizeof(int));
    *b = 200;
    dsc_sll_push_back(list, a); // [100]
    dsc_sll_push_back(list, b); // [100,200]
...
int test_remove_at_last(void)
{
    ...
    *b = 2;
    int* c = malloc(sizeof(int));
    *c = 3;
    dsc_sll_push_back(list, a); // [1]
    dsc_sll_push_back(list, b); // [1,2]
    dsc_sll_push_back(list, c); // [1,2,3]
...
int test_insert_remove_null_data(void)
{
    DSCAllocator alloc = create_int_allocator();
    DSCSinglyLinkedList* list = dsc_sll_create(&alloc);
    ASSERT_EQ(dsc_sll_push_back(list, NULL), 0); // allow nullptr data
    ASSERT_EQ(list->size, 1);
...
int test_mixed_operations_integrity(void)
{
    ...
    *c = 30;
    dsc_sll_push_back(list, a);  // [10]
    dsc_sll_push_front(list, b); // [20,10]
...
int test_remove_front(void)
{
    ...
    // Test on empty list
    ASSERT_EQ(dsc_sll_pop_front(list, true), -1);
    ...
    *c = 30;
    ...
    // Remove front
    ASSERT_EQ(dsc_sll_pop_front(list, true), 0);
    ASSERT_EQ(list->size, 2);
...
int test_remove_back(void)
{
    ...
    // Test on empty list
    ASSERT_EQ(dsc_sll_pop_back(list, true), -1);

    // Test on single element list
    int* a = malloc(sizeof(int));
    *a = 10;
    dsc_sll_push_back(list, a);
    ASSERT_EQ(dsc_sll_pop_back(list, true), 0);
    ASSERT_EQ(list->size, 0);
    ASSERT_NULL(list->head);
