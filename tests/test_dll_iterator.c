...
static int test_iterator_reset(void) {
    ...
    for (int i = 1; i <= 3; i++) { int* val = malloc(sizeof(int)); *val = i; dsc_dll_insert_back(list, val); }
...
static int test_reverse_iteration(void) {
    ...
    for (int i = 1; i <= 5; i++) { int* val = malloc(sizeof(int)); *val = i; dsc_dll_insert_back(list, val); }
...
static int test_from_iterator_basic(void) {
    ...
    for (int i = 1; i <= 5; i++) { int* val = malloc(sizeof(int)); *val = i; dsc_dll_insert_back(src_list, val); }
