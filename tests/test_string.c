...
int main(void)
{
    ...
    if (test_empty_string() != TEST_SUCCESS)
    {
        printf("test_empty_string failed\n");
        failed++;
    }
    if (test_assign_empty_cstring() != TEST_SUCCESS)
    {
        printf("test_assign_empty_cstring failed\n");
        failed++;
    }
    if (test_append_empty_cstring() != TEST_SUCCESS)
    {
        printf("test_append_empty_cstring failed\n");
        failed++;
    }
    if (test_insert_at_bounds() != TEST_SUCCESS)
    {
        printf("test_insert_at_bounds failed\n");
        failed++;
    }
    if (test_erase_out_of_bounds() != TEST_SUCCESS)
    {
        printf("test_erase_out_of_bounds failed\n");
        failed++;
    }
    if (test_substr_out_of_bounds() != TEST_SUCCESS)
    {
        printf("test_substr_out_of_bounds failed\n");
        failed++;
    }
    // Regular tests
    if (test_create_and_assign() != TEST_SUCCESS)
    {
        printf("test_create_and_assign failed\n");
        failed++;
    }
    if (test_append_and_insert() != TEST_SUCCESS)
    {
        printf("test_append_and_insert failed\n");
        failed++;
    }
    if (test_push_pop_erase() != TEST_SUCCESS)
    {
        printf("test_push_pop_erase failed\n");
        failed++;
    }
    if (test_find_and_compare() != TEST_SUCCESS)
    {
        printf("test_find_and_compare failed\n");
        failed++;
    }
    if (test_trim_and_case() != TEST_SUCCESS)
    {
        printf("test_trim_and_case failed\n");
        failed++;
    }
    if (test_substr() != TEST_SUCCESS)
    {
        printf("test_substr failed\n");
        failed++;
    }
    // Capacity and buffer management tests
    if (test_reserve_and_shrink() != TEST_SUCCESS)
    {
        printf("test_reserve_and_shrink failed\n");
        failed++;
    }
    if (test_buffer_growth() != TEST_SUCCESS)
    {
        printf("test_buffer_growth failed\n");
        failed++;
    }
    // Additional tests
    if (test_embedded_null() != TEST_SUCCESS)
    {
        printf("test_embedded_null failed\n");
        failed++;
    }
    if (test_large_string() != TEST_SUCCESS)
    {
        printf("test_large_string failed\n");
        failed++;
    }
    if (test_self_assign_and_append() != TEST_SUCCESS)
    {
        printf("test_self_assign_and_append failed\n");
        failed++;
    }
    if (test_trim_all_whitespace() != TEST_SUCCESS)
    {
        printf("test_trim_all_whitespace failed\n");
        failed++;
    }
    if (test_reserve_and_shrink_optimal() != TEST_SUCCESS)
    {
        printf("test_reserve_and_shrink_optimal failed\n");
        failed++;
    }
    if (test_compare_different_lengths() != TEST_SUCCESS)
    {
        printf("test_compare_different_lengths failed\n");
        failed++;
    }
    if (test_compare_different_contents() != TEST_SUCCESS)
    {
        printf("test_compare_different_contents failed\n");
        failed++;
    }
    if (test_find_first_of_no_match() != TEST_SUCCESS)
    {
        printf("test_find_first_of_no_match failed\n");
        failed++;
    }
    if (test_find_first_of_multiple_matches() != TEST_SUCCESS)
    {
        printf("test_find_first_of_multiple_matches failed\n");
        failed++;
    }
    if (test_remove_extra_ws() != TEST_SUCCESS)
    {
        printf("test_remove_extra_ws failed\n");
        failed++;
    }
    if (test_clear_non_empty() != TEST_SUCCESS)
    {
        printf("test_clear_non_empty failed\n");
        failed++;
    }
    if (test_pop_back_empty() != TEST_SUCCESS)
    {
        printf("test_pop_back_empty failed\n");
        failed++;
    }
    if (test_erase_empty() != TEST_SUCCESS)
    {
        printf("test_erase_empty failed\n");
        failed++;
    }
    if (test_to_lower_upper_already() != TEST_SUCCESS)
    {
        printf("test_to_lower_upper_already failed\n");
        failed++;
    }
    if (test_substr_create_zero_count() != TEST_SUCCESS)
    {
        printf("test_substr_create_zero_count failed\n");
        failed++;
    }
    if (test_compare_string_equality() != TEST_SUCCESS)
    {
        printf("test_compare_string_equality failed\n");
        failed++;
    }
    // Even more edge case tests
    if (test_clear_already_empty() != TEST_SUCCESS)
    {
        printf("test_clear_already_empty failed\n");
        failed++;
    }
    if (test_assign_string_different() != TEST_SUCCESS)
    {
        printf("test_assign_string_different failed\n");
        failed++;
    }
    if (test_insert_cstring_empty() != TEST_SUCCESS)
    {
        printf("test_insert_cstring_empty failed\n");
        failed++;
    }
    if (test_insert_string_empty() != TEST_SUCCESS)
    {
        printf("test_insert_string_empty failed\n");
        failed++;
    }
    if (test_append_string_empty() != TEST_SUCCESS)
    {
        printf("test_append_string_empty failed\n");
        failed++;
    }
    if (test_find_cstring_empty_search() != TEST_SUCCESS)
    {
        printf("test_find_cstring_empty_search failed\n");
        failed++;
    }
    if (test_find_string_empty_search() != TEST_SUCCESS)
    {
        printf("test_find_string_empty_search failed\n");
        failed++;
    }
    if (test_substr_create_string_count_exceeds() != TEST_SUCCESS)
    {
        printf("test_substr_create_string_count_exceeds failed\n");
        failed++;
    }
    if (test_substr_create_string_pos_at_size() != TEST_SUCCESS)
    {
        printf("test_substr_create_string_pos_at_size failed\n");
        failed++;
    }
    if (test_substr_create_string_pos_gt_size() != TEST_SUCCESS)
    {
        printf("test_substr_create_string_pos_gt_size failed\n");
        failed++;
    }
    if (test_substr_cstring_pos_at_length() != TEST_SUCCESS)
    {
        printf("test_substr_cstring_pos_at_length failed\n");
        failed++;
    }
    if (test_substr_cstring_pos_gt_length() != TEST_SUCCESS)
    {
        printf("test_substr_cstring_pos_gt_length failed\n");
        failed++;
    }
    if (test_compare_string_empty() != TEST_SUCCESS)
    {
        printf("test_compare_string_empty failed\n");
        failed++;
    }
    if (test_compare_cstring_empty() != TEST_SUCCESS)
    {
        printf("test_compare_cstring_empty failed\n");
        failed++;
    }
    if (test_getline_ch_empty_file() != TEST_SUCCESS)
    {
        printf("test_getline_ch_empty_file failed\n");
        failed++;
    }
    if (test_getline_cstring_empty_file() != TEST_SUCCESS)
    {
        printf("test_getline_cstring_empty_file failed\n");
        failed++;
    }
    if (test_assign_char() != TEST_SUCCESS)
    {
        printf("test_assign_char failed\n");
        failed++;
    }
    if (test_insert_char_positions() != TEST_SUCCESS)
    {
        printf("test_insert_char_positions failed\n");
        failed++;
    }
    if (test_append_char_multiple() != TEST_SUCCESS)
    {
        printf("test_append_char_multiple failed\n");
        failed++;
    }
    if (test_substr_create_cstring_cases() != TEST_SUCCESS)
    {
        printf("test_substr_create_cstring_cases failed\n");
        failed++;
    }
    if (test_compare_cstring_prefix_suffix() != TEST_SUCCESS)
    {
        printf("test_compare_cstring_prefix_suffix failed\n");
        failed++;
    }
    if (test_getline_ch_simulated() != TEST_SUCCESS)
    {
        printf("test_getline_ch_simulated failed\n");
        failed++;
    }
    if (test_getline_cstring_simulated() != TEST_SUCCESS)
    {
        printf("test_getline_cstring_simulated failed\n");
        failed++;
    }
    if (test_push_back_null_char() != TEST_SUCCESS)
    {
        printf("test_push_back_null_char failed\n");
        failed++;
    }
    if (test_append_char_null_char() != TEST_SUCCESS)
    {
        printf("test_append_char_null_char failed\n");
        failed++;
    }
    if (test_insert_char_out_of_bounds() != TEST_SUCCESS)
    {
        printf("test_insert_char_out_of_bounds failed\n");
        failed++;
    }
    if (test_insert_cstring_out_of_bounds() != TEST_SUCCESS)
    {
        printf("test_insert_cstring_out_of_bounds failed\n");
        failed++;
    }
    if (test_insert_string_out_of_bounds() != TEST_SUCCESS)
    {
        printf("test_insert_string_out_of_bounds failed\n");
        failed++;
    }
    if (test_erase_at_size() != TEST_SUCCESS)
    {
        printf("test_erase_at_size failed\n");
        failed++;
    }
    if (test_trim_front_already_trimmed() != TEST_SUCCESS)
    {
        printf("test_trim_front_already_trimmed failed\n");
        failed++;
    }
    if (test_trim_back_already_trimmed() != TEST_SUCCESS)
    {
        printf("test_trim_back_already_trimmed failed\n");
        failed++;
    }
    if (test_remove_extra_ws_only_spaces() != TEST_SUCCESS)
    {
        printf("test_remove_extra_ws_only_spaces failed\n");
        failed++;
    }
    if (test_to_lower_empty() != TEST_SUCCESS)
    {
        printf("test_to_lower_empty failed\n");
        failed++;
    }
    if (test_to_upper_empty() != TEST_SUCCESS)
    {
        printf("test_to_upper_empty failed\n");
        failed++;
    }
    if (test_substr_create_string_zero_count_zero_pos() != TEST_SUCCESS)
    {
        printf("test_substr_create_string_zero_count_zero_pos failed\n");
        failed++;
    }
    if (test_substr_create_cstring_zero_count_zero_pos() != TEST_SUCCESS)
    {
        printf("test_substr_create_cstring_zero_count_zero_pos failed\n");
        failed++;
    }
    if (test_substr_string_zero_count_zero_pos() != TEST_SUCCESS)
    {
        printf("test_substr_string_zero_count_zero_pos failed\n");
        failed++;
    }
    if (test_substr_cstring_zero_count_zero_pos() != TEST_SUCCESS)
    {
        printf("test_substr_cstring_zero_count_zero_pos failed\n");
        failed++;
    }
    if (test_compare_string_one_empty() != TEST_SUCCESS)
    {
        printf("test_compare_string_one_empty failed\n");
        failed++;
    }
    if (test_compare_cstring_one_empty() != TEST_SUCCESS)
    {
        printf("test_compare_cstring_one_empty failed\n");
        failed++;
    }
    if (test_getline_ch_delim_not_present() != TEST_SUCCESS)
    {
        printf("test_getline_ch_delim_not_present failed\n");
        failed++;
    }
    if (test_getline_cstring_delim_not_present() != TEST_SUCCESS)
    {
        printf("test_getline_cstring_delim_not_present failed\n");
        failed++;
    }
    if (test_assign_string_self() != TEST_SUCCESS)
    {
        printf("test_assign_string_self failed\n");
        failed++;
    }
    if (test_append_string_self() != TEST_SUCCESS)
    {
        printf("test_append_string_self failed\n");
        failed++;
    }
    if (test_insert_char_at_0_and_size() != TEST_SUCCESS)
    {
        printf("test_insert_char_at_0_and_size failed\n");
        failed++;
    }
    if (test_insert_cstring_at_0_and_size() != TEST_SUCCESS)
    {
        printf("test_insert_cstring_at_0_and_size failed\n");
        failed++;
    }
    if (test_insert_string_at_0_and_size() != TEST_SUCCESS)
    {
        printf("test_insert_string_at_0_and_size failed\n");
        failed++;
    }
    if (test_trim_front_back_only_ws() != TEST_SUCCESS)
    {
        printf("test_trim_front_back_only_ws failed\n");
        failed++;
    }
    if (test_remove_extra_ws_tabs_newlines() != TEST_SUCCESS)
    {
        printf("test_remove_extra_ws_tabs_newlines failed\n");
        failed++;
    }
    if (test_to_lower_upper_mixed() != TEST_SUCCESS)
    {
        printf("test_to_lower_upper_mixed failed\n");
        failed++;
    }
    if (test_find_first_of_empty_value() != TEST_SUCCESS)
    {
        printf("test_find_first_of_empty_value failed\n");
        failed++;
    }
    if (test_find_cstring_at_end() != TEST_SUCCESS)
    {
        printf("test_find_cstring_at_end failed\n");
        failed++;
    }
    if (test_find_string_at_end() != TEST_SUCCESS)
    {
        printf("test_find_string_at_end failed\n");
        failed++;
    }
    if (test_substr_create_string_count_0_pos_end() != TEST_SUCCESS)
    {
        printf("test_substr_create_string_count_0_pos_end failed\n");
        failed++;
    }
    if (test_substr_create_cstring_count_0_pos_end() != TEST_SUCCESS)
    {
        printf("test_substr_create_cstring_count_0_pos_end failed\n");
        failed++;
    }

    // Add robustness tests for NULL pointer and invalid values
    if (test_null_pointer_handling() != TEST_SUCCESS)
    {
        printf("test_null_pointer_handling failed\n");
        failed++;
    }
    if (test_invalid_values() != TEST_SUCCESS)
    {
        printf("test_invalid_values failed\n");
        failed++;
    }

    // str_free_split tests
    if (test_str_free_split_basic() != TEST_SUCCESS)
    {
        printf("test_str_free_split_basic failed\n");
        failed++;
    }
    if (test_str_free_split_nullptr() != TEST_SUCCESS)
    {
        printf("test_str_free_split_nullptr failed\n");
        failed++;
    }
    if (test_str_free_split_zero_count() != TEST_SUCCESS)
    {
        printf("test_str_free_split_zero_count failed\n");
        failed++;
    }

    // str_split tests
    if (test_str_split_basic() != TEST_SUCCESS)
    {
        printf("test_str_split_basic failed\n");
        failed++;
    }
    if (test_str_split_no_delim() != TEST_SUCCESS)
    {
        printf("test_str_split_no_delim failed\n");
        failed++;
    }
    if (test_str_split_empty_string() != TEST_SUCCESS)
    {
        printf("test_str_split_empty_string failed\n");
        failed++;
    }
    if (test_str_split_nullptr() != TEST_SUCCESS)
    {
        printf("test_str_split_nullptr failed\n");
        failed++;
    }

    // str_split and str_free_split combined test
    if (test_str_split_and_free_split() != TEST_SUCCESS)
    {
        printf("test_str_split_and_free_split failed\n");
        failed++;
    }
