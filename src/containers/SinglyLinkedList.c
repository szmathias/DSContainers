...
// customizable allocator (ANVAllocator). The API mirrors the doubly-linked list
 ...
 */
static ANVSinglyLinkedNode* sll_sort_helper_merge(ANVSinglyLinkedNode* left, ANVSinglyLinkedNode* right, const cmp_func compare)
{
    if (!left)
    {
        return right;
